function toggleTheme() {
    ...
    const elements = document.querySelectorAll('.navbar, .content, footer,menu,.menu__link, .moviessection , .topnav, .button2,body, movie-info, #details p'); // Select multiple elements
...
window.addEventListener('load', function() {
    ...
    // Programmatically trigger autoplay by reloading the iframe src
    iframe.src = iframeSrc + "&autoplay=1";  // You can append autoplay if not already in the URL
  });
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Eğer sayfa URL'si '/contact' ise footer'ı gizle
